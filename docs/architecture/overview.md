...
comfortably carries 10,000 employees' worth of relational data (`docs/architecture/database-schema.md`
...
- **Outstanding Payroll Obligations (added 2026-07-08)** — the seam Payroll Processing's new-cycle
  ...
  containing module-specific knowledge (`docs/architecture/data-and-storage.md` §4). Each owning
  ...
  new cycle, per BR-ADV-001–006, `docs/architecture/database-schema.md` §15). A future obligation type
