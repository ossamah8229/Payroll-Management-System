...
/** Routes through `computeEntryCalc` (Payroll Financial Integrity checkpoint, 2026-08-28) — an
 * employee's payroll history spans every cycle status, so this must never silently re-derive a
