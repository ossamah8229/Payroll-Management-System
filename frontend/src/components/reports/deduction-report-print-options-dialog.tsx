...
/**
 * Deduction Report Checkpoint 1B — this report's own Print Options dialog, opened by its Print
 ...
 */
export function DeductionReportPrintOptionsDialog({
  open,
  onOpenChange,
  onConfirm,
}: {
  ...
  onConfirm: (selection: DeductionReportPrintSelection) => void;
}) {
  const [selection, setSelection] = useState<DeductionReportPrintSelection>(DEFAULT_PRINT_SELECTION);
