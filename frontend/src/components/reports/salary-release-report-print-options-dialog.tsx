...
/**
 * Salary Release Report Checkpoint 1B — this report's own Print Options dialog, opened by its Print
 ...
 */
export function SalaryReleaseReportPrintOptionsDialog({
  open,
  onOpenChange,
  onConfirm,
}: {
  ...
  onConfirm: (selection: SalaryReleaseReportPrintSelection) => void;
}) {
  const [selection, setSelection] = useState<SalaryReleaseReportPrintSelection>(DEFAULT_PRINT_SELECTION);
